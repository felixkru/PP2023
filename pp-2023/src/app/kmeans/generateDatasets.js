"use client";
import { GenerateImage } from "./downloadChartButton";
...
const fillInData = (kMeansResult, kMeansOrElbow) => {
  //pos ist hier die aktuelle position der Schleife bzw. des Clusters aus generateDatasets
  let data = [];
  if (kMeansResult) {
